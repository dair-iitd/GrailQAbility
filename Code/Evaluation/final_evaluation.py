...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, help='tells which model to evaluate')
    ...
    with open(predict_path) as f:
        if args.model == 'retrack' or args.model == 'tiara':
            predict = json.load(f)  # should be of format {qid: {logical_form: <str>, answer: <list>}}
        elif args.model == 'rng':
            predict = proc_prediction(f) ## for RnG
